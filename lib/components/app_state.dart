...
import 'package:justsharelah_v1/components/JslUser.dart';
...
class AppState extends ChangeNotifier {
  ...
  /// The extraData from [user], mapped to an [JslUser] object.
  JslUser? get JslUser => _JslUser;
  ...
  Future<bool> connect(DemoAppUser demoUser) async {
    ...
    if (currentUser.data != null) {
      _JslUser = JslUser.fromMap(currentUser.data!);
  ...
  ///
  /// This will call [notifyListeners] and update the local [_JslUser] state.
  Future<void> updateProfilePhoto(String filePath) async {
    ...
    if (_JslUser != null) {
      await client.currentUser!.update(_JslUser!.toMap());
    }
